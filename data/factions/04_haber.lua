...
local f = Faction:new('Korporacja Haber')
	:description_short('Korporacja Haber')
	:description('Totalitarne państwo korporacyjne kontrolowana przez zarząd dyrektorów generalnych')
	:homeworld(4,-9,-17,0,21)
	:foundingDate(3150.0)
	:expansionRate(0.5)
	:military_name('Dywizja Floty Haber')
	:police_name('Dywizja Egzekutywy Haber')
	:colour(1.0,0.4,0.4)
