...
local s_diso = CustomSystem:new("Diso",{'STAR_G'})
	:govtype('LIBDEM')
	:short_desc('Planeta ta znana była z upraw tulipanów Ouza, obecnie zniszczonych przez częste trzęsienia ziemi.')
	:long_desc([[Planeta ta znana była z upraw tulipanów Ouza, obecnie zniszczonych przez częste trzęsienia ziemi.]])
	:explored(true)
...
local s_lave = CustomSystem:new("Lave",{'STAR_K'})
	:govtype('MILDICT1')
	:short_desc('Lave słynie ze swoich rozległych lasów deszczowych i Laveiańskiej larwy drzewnej.')
	:long_desc([[Lave słynie ze swoich rozległych lasów deszczowych i Laveiańskiej larwy drzewnej.]])
	:explored(true)
...
local s_leesti = CustomSystem:new("Leesti",{'STAR_G'})
	:govtype('CORPORATE')
	:short_desc('Planeta Leesti jest dość znana z krykieta Zero-G i ohydnego soku Leestiańskiego.')
	:long_desc([[Planeta Leesti jest dość znana z krykieta Zero-G i ohydnego soku Leestiańskiego.]])
	:explored(true)
...
local s_orerve = CustomSystem:new("Orerve",{'STAR_K'})
	:govtype('PLUTOCRATIC')
	:short_desc('Ta planeta to nudne miejsce.')
	:long_desc('Ta planeta to nudne miejsce. Z wyjątkiem entuzjazmu dla sera. Ubierz się ciepło.')
	:explored(true)
...
local s_orrere = CustomSystem:new("Orrere",{'STAR_G'})
	:govtype('CORPORATE')
	:short_desc('Orrere dość znana z Orrerjańskiego zdradliwego naparu.')
	:long_desc('Orrere dość znana z Orrerjańskiego zdradliwego naparu.')
	:explored(true)
...
local s_reorte = CustomSystem:new("Reorte",{'STAR_G'})
	:govtype('MILDICT1')
	:short_desc("Planeta ta znana jest z oferowania ekscentrycznych przyjemności dla turystów, lecz nękana jest przez wyniszczające trzęsienia ziemi.")
	:long_desc("Planeta ta znana jest z oferowania ekscentrycznych przyjemności dla turystów, lecz nękana jest przez wyniszczające trzęsienia ziemi.")
	:explored(true)
...
local s_riedquat = CustomSystem:new("Riedquat",{'STAR_G'})
	:govtype('DISORDER')
	:short_desc('Planeta znana z wyśmienitej kuchni, sporadycznie nękana przez wojny domowe.')
	:long_desc('Planeta znana z wyśmienitej kuchni, sporadycznie nękana przez wojny domowe.')
	:explored(true)
...
local s_tionisla = CustomSystem:new('Tionisla',{'STAR_M'})
	:govtype('CISLIBDEM')
	:short_desc("Ten świat wiele znaczy dla jego mieszkańców o wrodzonej nieśmiałości.")
	:long_desc("Ten świat wiele znaczy dla jego mieszkańców o wrodzonej nieśmiałości.")
	:explored(true)
...
local s_uszaa = CustomSystem:new('Uszaa',{'STAR_G'})
	:govtype('DISORDER')
	:short_desc("Planeta Uszaa znana jest z oferowania ekscentrycznych przyjemności dla turystów i Uszaańskiej larwy drzewnej.")
	:long_desc("Planeta Uszaa znana jest z oferowania ekscentrycznych przyjemności dla turystów i Uszaańskiej larwy drzewnej.")
	:explored(true)
...
local s_zaonce = CustomSystem:new('Zaonce',{'STAR_K'})
	:govtype('CORPORATE')
	:short_desc('Tradycyjna siedziba wielu nowoczesnych firm.')
	:long_desc('Tradycyjna siedziba wielu nowoczesnych firm.')
	:explored(true)
